 ...
 */
@Log4j
@Component("shopInsetRunnerImpl")
public class ShopInsertRunnerImpl implements TaskRunner {

    String type= TaskKafkaConstant.Type.SHOP_INSERT;

    Class itemClass= TaskKafkaConstant.ClassMap.INSERT_SHOP;
