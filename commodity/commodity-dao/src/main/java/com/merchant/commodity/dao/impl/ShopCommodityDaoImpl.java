package com.merchant.commodity.dao.impl;
...
import com.merchant.commodity.mapper.ShopCommodityMapper;
...
import com.merchant.commodity.util.ResultCommodityUtil;
...
public class ShopCommodityDaoImpl implements ShopCommodityDao {
    ...
    public ShopCommodityResult insertShopCommodity(ShopCommodity shopCommodity) {
        ...
        try {
            ...
            ResultCommodityUtil.dealUpsert(status, shopCommodity, res);
        } catch (Exception e) {
    ...
    public ShopCommodityResult queryShopCommodityByRequest(ShopCommodityRequest request) {
        ...
        try {
            ...
            if (request.isPaging()) {
                ...
                ResultCommodityUtil.resultValues(res, shopCommodityIPage.getRecords());
                ResultCommodityUtil.resultCountWithPaging(res, (int) shopCommodityIPage.getTotal(), request.getPage());
            } else {
                List<ShopCommodity> list = mapper.selectList(wp);
                ResultCommodityUtil.resultValues(res, list);
            }
            ResultCommodityUtil.resultSuccess(res);
