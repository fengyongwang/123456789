...
`referral_code` VARCHAR(255) DEFAULT NULL COMMENT '客户邀请码',
`other_referral_code` VARCHAR(255) DEFAULT NULL COMMENT '客户唯一编码',
`Omodify_number` VARCHAR(10) DEFAULT NULL COMMENT '客户唯一编码是否修改过',
